/**
 * User-friendly error messages for Robinhood Connect
 */
...
export const ERROR_MESSAGES = {
  ...
  // Validation errors
  INVALID_CONNECT_ID: "Invalid transfer reference. Please start a new transfer.",
...
export function getErrorMessage(errorCode: string): string {
  return (
    ERROR_MESSAGES[errorCode as ErrorCode] || ERROR_MESSAGES.UNKNOWN_ERROR
  );
}
